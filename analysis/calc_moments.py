...
hundred_k_mean_var = (run15_var + run16_var + run17_var) / 3
hundred_k_std = calc_std_dev(run15_var, run16_var, run17_var)
hundred_k_corrected = hundred_k_mean_var - amp_baseline
hundred_k_skew = (run15_skew + run16_skew + run17_skew) / 3
hundred_k_skew_std = calc_std_dev(run15_skew, run16_skew, run17_skew)
hundred_k_kurt = (run15_kurt + run16_kurt + run17_kurt) / 3
hundred_k_kurt_std = calc_std_dev(run15_kurt, run16_kurt, run17_kurt)
